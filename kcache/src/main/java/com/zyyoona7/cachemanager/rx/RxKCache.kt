...
class RxKCache @JvmOverloads internal constructor(cacheManager: CacheManager = KCache.getCache()) {
     ...
     * @return JSONObject
     */
    fun getJsonObj(key: String, password: String = mEncryptPwd): Observable<Optional<JSONObject>> {
    ...
    fun getJsonObj(key: String, defaultValue: JSONObject? = JSONObject(),
                   password: String = mEncryptPwd): Observable<Optional<JSONObject>> {
        return toObservable {
     ...
     */
    fun getJsonArray(key: String, password: String = mEncryptPwd): Observable<Optional<JSONArray>> {
    ...
    fun getJsonArray(key: String, defaultValue: JSONArray? = JSONArray(),
                     password: String = mEncryptPwd): Observable<Optional<JSONArray>> {
        return toObservable {
     ...
     */
    fun getBitmap(key: String, password: String = mEncryptPwd): Observable<Optional<Bitmap>> {
    ...
    fun getBitmap(key: String, defaultValue: Bitmap? = null,
                  password: String = mEncryptPwd): Observable<Optional<Bitmap>> {
        return toObservable {
     ...
     */
    fun getDrawable(key: String, password: String = mEncryptPwd): Observable<Optional<Drawable>> {
    ...
    fun getDrawable(key: String, defaultValue: Drawable? = null,
                    password: String = mEncryptPwd): Observable<Optional<Drawable>> {
        return toObservable {
    ...
    fun getString(key: String, defaultValue: String = "",
                  password: String = mEncryptPwd): Observable<Optional<String>> {
        return toObservable {
     ...
     * @return ByteArray
     */
    fun getByteArray(key: String, password: String = mEncryptPwd): Observable<Optional<ByteArray>> {
    ...
    fun getByteArray(key: String, defaultValue: ByteArray? = null,
                     password: String = mEncryptPwd): Observable<Optional<ByteArray>> {
        return toObservable {
    ...
    fun <T : Any> getSerializable(key: String, defaultValue: T? = null,
                                  password: String = mEncryptPwd): Observable<Optional<T>> {
        return toObservable {
    ...
    /**
     * get时候调用返回Observable<Optional<T>>
     */
    private fun <T : Any> toObservable(block: (CacheManager) -> T?): Observable<Optional<T>> {
        return Observable.create<Optional<T>> {
            val value = block(mCacheManager)
            it.onNext(value.toOptional())
            it.onComplete()
        }
    }
     ...
     */
    private fun <T> toObservable(emitterValue: T, block: (CacheManager) -> Unit): Observable<T> {
